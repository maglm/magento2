...
class Save extends \Sample\Trial\Controller\Adminhtml\Items
{
        ...
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('sample_trial/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('sample_trial/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('sample_trial/*/new');
                }
                return;
            } catch (\Exception $e) {
